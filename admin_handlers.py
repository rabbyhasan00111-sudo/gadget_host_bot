# ╔══════════════════════════════════════════════════════════════════════╗
# ║   ⚡ GADGET PREMIUM HOST  v3.0  ·  admin_handlers.py                ║
# ╚══════════════════════════════════════════════════════════════════════╝
...
def _server_text() -> str:
    ...
    cpu_bar  = utils.pbar(cpu,           100)
    mem_bar  = utils.pbar(mem.percent,   100)
    dsk_bar  = utils.pbar(disk.percent,  100)
    ...
    return (
        ...
        f"💾  RAM:    {mem_bar} <code>{utils.fmt_bytes(mem.used)}/{utils.fmt_bytes(mem.total)}</code>\n"
        f"    Avail:  <code>{utils.fmt_bytes(mem.available)}</code>\n\n"
        f"💿  DISK:   {dsk_bar} <code>{disk.percent:.1f}%</code>\n"
